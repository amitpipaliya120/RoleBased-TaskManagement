...
BEGIN
    ...
    PRINT 'tblRolesMaster created and seeded.';
END
GO
...
BEGIN
    ...
    PRINT 'tblUsersMaster created.';
    INSERT INTO tblUsersMaster (Name, Email, PasswordHash, RoleId, IsActive)
    VALUES ('Admin', 'admin@gmail.com', '$2a$11$tZZX7MTkqfeN2gYCznTWh.4Xq5aAQbWOTTp4vCY7T.ENpPO8qODe6', 1, 1);
...
BEGIN
    ...
    BEGIN
        ...
        PRINT 'ManagerId column added to tblUsersMaster.';
    END
END
GO
...
BEGIN
    ...
    PRINT 'tblCommentsMaster created.';
END
GO
...
PRINT 'All tables and stored procedures are up to date.';
PRINT '========================================';
GO
